        ...
        table: {
            ...
            responseHandler: function (res) {
                ...
                if (res.code == web_status.SUCCESS) {
                    //返回页码解密
                    if ($.common.isNotEmpty(res.t)) {
                        var key = CryptoJS.enc.Utf8.parse("YafyuNHCEMDDAaTT");
                        var decryptedData = CryptoJS.AES.decrypt(res.t, key, {
                            mode: CryptoJS.mode.ECB,
                            padding: CryptoJS.pad.Pkcs7
                        });
                        res.total = CryptoJS.enc.Utf8.stringify(decryptedData).toString();
                    }
